...
export const cvContent: Record<Language, CvContent> = {
  "pt-BR": {
    ...
    metrics: [
      {
        value: "Invest Smart XP",
        label: "atuação atual",
        detail: "Analista de Sistemas — desenvolvimento full stack em plataformas internas.",
      },
      {
        value: "Eng. da Computação + Pós",
        label: "formação",
        detail: "Bacharel pela UVA e pós em Arquitetura de Software na PUC Campinas.",
      },
      {
        value: "Front-end & UX/UI",
        label: "diferencial",
        detail: "Design systems e interfaces centradas no usuário, do Figma ao React.",
      },
      {
    ...
    metrics: [
      {
        value: "Invest Smart XP",
        label: "current role",
        detail: "Systems Analyst — full stack development on internal platforms.",
      },
      {
        value: "Computer Eng. + Postgrad",
        label: "education",
        detail: "Bachelor's (UVA) and a postgraduate in Software Architecture (PUC Campinas).",
      },
      {
        value: "Front-end & UX/UI",
        label: "edge",
        detail: "Design systems and user-centered interfaces, from Figma to React.",
      },
      {
