...
export function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="relative z-0 overflow-hidden bg-[#0a2119] px-4 py-24 text-white sm:px-6 sm:py-28 lg:py-32"
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-20 bg-[linear-gradient(180deg,rgba(6,20,15,0.7)_0%,rgba(8,28,21,0.4)_22%,rgba(10,33,25,0.16)_60%,rgba(10,33,25,0)_100%)]" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-[linear-gradient(0deg,rgba(6,20,15,0.7)_0%,rgba(8,28,21,0.4)_22%,rgba(10,33,25,0.16)_60%,rgba(10,33,25,0)_100%)]" />
      ...
      <div className="mx-auto max-w-7xl space-y-6 sm:space-y-8">
        ...
        <div className="grid auto-rows-min grid-cols-1 gap-5 md:grid-cols-3 md:gap-6">
          <div
            className={`group relative flex min-h-72 cursor-default flex-col justify-between overflow-hidden rounded-3xl border border-white/10 bg-[rgba(13,32,25,0.9)] p-5 md:col-span-1 md:min-h-100 md:p-8 ${cardHoverProfile}`}
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(260px circle at 50% 40%, rgba(47,107,87,0.20), rgba(63,127,95,0.10) 38%, rgba(8,15,12,0) 68%), linear-gradient(135deg, rgba(47,107,87,0.10) 0%, rgba(15,18,16,0) 45%, rgba(63,127,95,0.10) 100%)",
              }}
            />
          ...
          <div
            className={`group relative flex cursor-default flex-col justify-center gap-5 overflow-hidden rounded-3xl border border-white/10 bg-[rgba(13,32,25,0.9)] p-5 md:col-span-2 md:p-10 ${cardHoverWho}`}
          >
            <div
              className="pointer-events-none absolute inset-0 rounded-3xl opacity-0 transition-opacity duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:opacity-100"
              style={{
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-sm leading-relaxed text-gray-400 md:text-base">
                ...
                <a
                  href="#projects"
                  className="text-white underline decoration-[#3f7f5f] underline-offset-4 transition-all hover:text-[#8fbfa8] hover:decoration-[#7fa08f]"
                >
              ...
              <p className="text-sm leading-relaxed text-gray-400 md:text-base">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-medium text-white underline decoration-[#3f7f5f] underline-offset-4 transition-all hover:text-[#8fbfa8] hover:decoration-[#7fa08f]"
                >
          ...
          <div
            className={`relative flex min-h-56 cursor-default flex-col justify-center gap-5 overflow-hidden rounded-3xl border border-white/10 bg-[linear-gradient(135deg,rgba(12,30,23,0.95)_0%,rgba(13,34,27,0.93)_52%,rgba(17,44,34,0.9)_100%)] p-5 md:col-span-2 md:min-h-62.5 md:p-8 ${cardHoverGlobal}`}
          >
          ...
          <div
            className={`relative min-h-72 overflow-hidden rounded-3xl border border-white/10 bg-[rgba(10,28,21,0.94)] md:col-span-1 md:min-h-87 ${cardHoverGlobal}`}
          >
            <div className="absolute inset-0 bg-[radial-gradient(78%_58%_at_50%_4%,rgba(127,160,143,0.14),rgba(5,12,9,0)_62%)]" />
