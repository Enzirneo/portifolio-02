      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-[0.64fr_1.36fr] gap-8 sm:gap-10 xl:gap-12 items-start">
        <div className="space-y-6 sm:space-y-7">
          <div className="flex justify-center xl:justify-start">
            <span className="inline-flex items-center gap-2 rounded-full border border-[#7fa08f]/18 bg-[#2f6b57]/12 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[#dce9e2]">
          ...
          <div className="space-y-4 text-center xl:text-left">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-white">
              ...
              <span className="font-serif italic text-[#b7d4c6]">
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-white/8 bg-black/15 px-4 py-4 text-sm text-gray-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.02)]">
            <MousePointer2 className="mt-0.5 h-4 w-4 shrink-0 text-[#9bc1af]" />
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-[#7fa08f]/16 bg-[#2f6b57]/12 px-4 py-2 text-sm font-medium text-[#edf6f1] transition-colors hover:bg-[#2f6b57]/16"
              >
                ...
                <button
                  ...
                  className={`shrink-0 rounded-full border px-4 py-2 text-sm font-medium transition-colors ${
                    activePresetIndex === index
                      ? "border-cyan-300/20 bg-cyan-300/7 text-[#edf6f1]"
            ...
            <div className="flex flex-col gap-4 text-center sm:text-left sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center justify-center gap-2 sm:justify-end">
                <button
                  type="button"
                  onClick={runFlow}
                  className="inline-flex items-center gap-2 rounded-full border border-cyan-300/14 bg-cyan-300/6 px-4 py-2 text-sm font-medium text-[#edf6f1] transition-colors hover:bg-cyan-300/10"
                >
              ...
              <div className="sticky top-0 z-20 border-b border-white/8 bg-[#07111c]/96 px-4 pb-4 pt-4 backdrop-blur-md">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  <button
                    type="button"
                    onClick={runFlow}
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-cyan-300/14 bg-cyan-300/6 px-4 py-2.5 text-sm font-medium text-[#edf6f1] transition-colors hover:bg-cyan-300/10"
                  >
                    <Play className="h-4 w-4" />
                    {copy.automation.controls.play}
                  </button>
