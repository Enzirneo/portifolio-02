          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 w-full sm:w-auto mt-4 sm:mt-0 justify-center">
              <a
                ...
                className="text-gray-500 hover:text-[#161616] transition-colors"
              >
            ...
            <div className="text-sm font-medium text-gray-500 text-center sm:text-left leading-relaxed sm:flex sm:items-center sm:gap-1 sm:whitespace-nowrap">
              <p className="sm:hidden">
                &copy; {new Date().getFullYear()} Bispo
              </p>
              <p className="hidden sm:block">
                ...
                >
                  ...
                  <span className="text-[#161616]/90 transition-colors group-hover:text-cyan-100">
                    Bispo
                  </span>
                  <span className="text-cyan-300">&gt;</span>
                </Link>
